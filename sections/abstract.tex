...
%
% Problem
Unfortunately, validating the accuracy of the formalized hardware model is hard. It not only requires relating the model's specification to the observable behavior of real hardware, but also involves many invisible internal steps that influence the observable execution of a modern processor. 
