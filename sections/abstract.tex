...
% Results
We discuss this methodology in the context of a model of the \hl{TLB and page tables of the} x86 MMU, demonstrating that synthesis can recover internal microarchitectural steps that explain observed hardware behavior. \hl{This includes our approach to scale this process by employing a state-reduction method exploiting specific model-related ideas, which can also be adapted to other model contexts.} 