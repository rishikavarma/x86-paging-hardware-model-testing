...
Finally, we split each test case into its per-core parts and save them as assembly files, which are linked into the test harness.
...
We implemented the test generator in Rust with the help of an executable model that is also written in Rust. The test-generation component is implemented in 263 lines of Rust code. This includes the implementation of graph-based test-case generation, limiting test-case lengths, and inserting appropriate memory operations, page invalidations, and barriers.
