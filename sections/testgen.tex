...
We implemented the test generator with Rust in 772 LoC, using an executable model of the x86 MMU. This includes implementing graph-based test case generation, inserting appropriate memory operations, page invalidations, and barriers, and per-core test sequence output. Test case length limit implementation is work in progress.
