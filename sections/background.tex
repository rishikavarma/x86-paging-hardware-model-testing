...
A processor effectively executes a sequence of events, which we can classify into externally observable and invisible internal microarchitectural events.
