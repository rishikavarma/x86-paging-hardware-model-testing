...
During validation, we need to identify the \emph{missing} internal microarchitectural steps that justify the observable trace. 
\hl{To ease analysis of large number or length of traces, we propose automating it by casting this into a software synthesis problem instead of requiring manual intervention.}
